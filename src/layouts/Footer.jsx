...
export default function Footer() {
  return (
    <footer className="relative bg-neutral-950 text-white overflow-hidden border-t border-white/5">
      {/* Very subtle pink ambient glow to tie into the brand without being loud */}
        ...
        <div className="py-16 sm:py-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            <Link to="/" className="inline-block mb-5">
              <span className="text-3xl font-light tracking-wider text-white">PHILIS</span>
            </Link>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-4 mb-6">
              ...
              >
                ...
                <p className="text-gray-500 text-xs">Al Khalidiya, Doha, Qatar</p>
              </a>
              <a
