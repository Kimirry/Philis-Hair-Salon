        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-18 sm:h-20">
            ...
            <Link to="/" className="flex-shrink-0 group">
              <span className="text-2xl sm:text-3xl font-light tracking-wider text-gray-900 group-hover:text-pink-500 transition-colors duration-300">
                PHILIS
              </span>
              <span className={`block text-[10px] tracking-[0.15em] italic transition-colors duration-300 ${
                scrolled ? "text-pink-400" : "text-pink-400/70"
              }`}>
                Making girls feel awesome
              </span>
            </Link>
              ...
              <div className="flex flex-col h-full">
                <div className="flex items-center justify-between px-6 py-5 border-b border-pink-50">
                  <div>
                    ...
                    <p className="text-[10px] text-pink-400 italic">Making girls feel awesome</p>
                  </div>
                  <button
                    onClick={() => setMobileOpen(false)}
