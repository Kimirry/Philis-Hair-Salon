        ...
        {mobileOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className={`absolute inset-y-0 w-full max-w-sm overflow-y-auto bg-white shadow-2xl ${
                language === "AR"
                  ? "left-0"
                  : "right-0"
              }`}
            >
              <div className="flex min-h-full flex-col p-6">
                ...
                {/* SOCIAL CONNECTION */}
                <div className="mt-8">
                  <p className="text-[10px] font-medium uppercase tracking-[0.25em] text-pink-500">
                    {t.nav.connect}
                  </p>
