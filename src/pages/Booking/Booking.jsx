...
const steps = [
  {
    ...
    description: "Take a moment to browse our treatments and find the experience that feels right for you.",
    link: "/services",
  ...
  },
  {
    ...
    description: "Reach out on WhatsApp with your preferred service, date, and time. Feel free to ask any questions beforehand.",
    link: WHATSAPP_URL,
  ...
  },
  {
    ...
    description: "Our team will reply promptly during business hours to secure your slot and share any preparation details.",
  },
  {
    number: "04",
    title: "Arrive & Unwind",
    description: "Show up at your booked time, settle in, and let our specialists take care of the rest.",
  },
];
...
export default function Booking() {
  return (
    <>
      {/* =========================================================
          PAGE HEADER (Tighter spacing, narrower text)
      ========================================================= */}
      <section className="relative pt-24 pb-8 sm:pt-32 sm:pb-10 bg-gradient-to-b from-pink-50/50 to-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Securing your time at Philis is intentionally simple. Skip the complicated 
            forms—just send us a quick message, and we’ll handle the details for you.
          </motion.p>
        </div>
      </section>

      {/* =========================================================
          MAIN WHATSAPP CTA (Denser padding, refined text)
      ========================================================= */}
      <section className="px-4 sm:px-6 lg:px-8 -mt-2 mb-10">
        <motion.div
          ...
          className="max-w-3xl mx-auto bg-gradient-to-br from-green-500 to-green-600 rounded-3xl p-6 sm:p-10 text-center shadow-2xl shadow-green-500/20"
        >
          ...
          <p className="text-green-100 mb-6 max-w-md mx-auto text-sm sm:text-base">
            Tap below to open WhatsApp. It only takes a few seconds to lock in your preferred time.
          </p>
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-white text-green-600 px-7 py-3.5 rounded-full text-sm font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
          >
          ...
          <p className="text-green-200/60 text-xs mt-3">+974 5525 7237</p>
        </motion.div>
      </section>

      {/* =========================================================
          HOW IT WORKS (Tighter vertical rhythm, smaller icons)
      ========================================================= */}
      <section className="pb-10 sm:pb-14 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="text-2xl sm:text-3xl font-light text-gray-900 text-center mb-8"
          >
                  ...
                  {step.link && (
                    step.external ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 text-rose-500 hover:text-rose-600 text-xs font-medium transition-colors"
                      >
                        {step.linkText}
