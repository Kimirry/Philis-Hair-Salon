...
const infoCards = [
  ...
  },
  {
    ...
    lines: ["Reserved for your convenience", "With every confirmed booking"],
  },
];
...
export default function Contact() {
  return (
    <>
      {/* =========================================================
          PAGE HEADER (Tighter spacing, narrower text block)
      ========================================================= */}
      <section className="relative pt-24 pb-8 sm:pt-32 sm:pb-10 bg-gradient-to-b from-pink-50/50 to-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.span
            ...
            className="inline-block text-xs sm:text-sm tracking-[0.25em] uppercase text-rose-400 font-medium mb-3"
          >
            Your Visit
          </motion.span>
          ...
          >
            Finding your moment of calm should be easy. We're nestled in Al Khalidiya 
            with complimentary parking arranged for every confirmed appointment. For 
            the quickest response regarding availability or inquiries, reach out to 
            us directly via WhatsApp.
          </motion.p>
        </div>
      </section>

      {/* =========================================================
          INFO CARDS (Tighter gaps and padding)
      ========================================================= */}
            ...
            >
              ...
              {card.lines.map((line) =>
                card.href && card.external ? (
                  <a key={line} href={card.href} target="_blank" rel="noopener noreferrer" className="block text-gray-500 hover:text-rose-500 transition-colors text-xs">
                    {line}
                  </a>
                ) : (
      ...
      {/* =========================================================
          MAP (Less bottom margin, shorter aspect ratio)
      ========================================================= */}
      <section className="px-4 sm:px-6 lg:px-8 mb-10">
        <motion.div
          ...
          className="max-w-6xl mx-auto relative aspect-[16/8] sm:aspect-[16/6] rounded-3xl overflow-hidden shadow-xl border border-gray-100"
        >
          <iframe
          ...
          <div className="absolute bottom-4 left-4 sm:bottom-5 sm:left-5 bg-white/95 backdrop-blur-md rounded-xl px-4 py-3 shadow-lg">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-xs text-rose-500 font-medium mt-1.5 hover:text-rose-600 transition-colors"
            >
              Get Directions
      ...
      {/* =========================================================
          HOURS (Tighter internal and external spacing)
      ========================================================= */}
        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-light text-gray-900">
              Salon <span className="font-medium">Hours</span>
            </h2>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gray-50/80 rounded-2xl p-5 sm:p-6 border border-gray-100"
          >
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <p className="text-xs text-rose-500 font-medium flex items-center gap-2 justify-center">
                ...
                To ensure a relaxed experience, our last appointment is accepted at 6:00 PM
              </p>
            </div>
          </motion.div>
        </div>
      ...
      {/* =========================================================
          WHATSAPP CTA (Compact and punchy)
      ========================================================= */}
        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-gray-500 mb-5 text-sm leading-relaxed">
              Whether you have a question about a specific service or want to check 
              our next available slot, send us a WhatsApp. It's the most direct 
              line to our team.
            </p>
            <a
              href={WHATSAPP_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-7 py-3.5 rounded-full text-sm font-medium transition-all duration-300 shadow-lg shadow-green-500/25"
            >
