...
export default function BookingCTA() {
  return (
    <section className="relative py-24 sm:py-32 overflow-hidden bg-stone-50">
      {/* Subtle, restful ambient light on white background */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-xl shadow-gray-200/60 border border-gray-100">
              ...
              {/* Soft bottom fade for video text */}
          ...
          {/* Right: Text - Soft, dark, and inviting */}
          <motion.div
            initial={{ opacity: 0, x: 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: "-100px" }}
          ...
          >
            <span className="inline-block text-xs sm:text-sm tracking-[0.25em] uppercase text-pink-500 font-medium mb-6">
              Book Your Visit
            </span>
