...
const contactInfo = [
  {
    ...
    label: "Location",
    value: "Najma, Doha, Qatar",
    secondary: "Al Khalidiya St",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-500 max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
            Find Philis Hair Salon in Najma, Doha, along Al Khalidiya St.
            Contact us on WhatsApp to arrange your appointment and parking.
          </p>
        </motion.div>
                  ...
                  <div className="min-w-0">
                    ...
                    {item.href ? (
                      <a
                        ...
                        className="text-gray-900 font-medium hover:text-pink-500 transition-colors"
                      >
                        {item.value}
                      </a>
                    ) : (
          ...
          >
            ...
            <div className="relative w-full aspect-[4/3] sm:aspect-[16/10] rounded-3xl overflow-hidden shadow-xl border border-gray-100">
              ...
              <iframe
                ...
                title="Philis Hair Salon in Najma, Doha, Qatar"
